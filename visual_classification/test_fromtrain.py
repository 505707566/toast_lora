...
def train(cfg, args):
    ...
    test_loader = get_loaders(cfg, logger)
    logger.info("Constructing models...")
    model, cur_device = build_model(cfg)
    model.load_state_dict(torch.load("/home/workspace/chaohao/ggk/TOAST/visual_classification/output/StanfordCars/vit_fb_ppt_small_patch16_224/lr0.01_wd0.0001/run26/model_ckpt_epoch100.pth")["model_state_dict"], strict=True)
